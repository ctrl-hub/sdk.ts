...
export class BaseService<T extends Model> extends RequestBuilder {
    ...
    async get(params?: string): Promise<InternalResponse<T[]>>;
    async get(param: string): Promise<InternalResponse<T>>;
    async get(param: string, options?: RequestOptionsType, params?: unknown): Promise<InternalResponse<T>>;
    async get(param: RequestOptionsType, params?: unknown): Promise<InternalResponse<T[]>>;
    async get(param?: string | RequestOptionsType, options?: RequestOptionsType, params?: unknown): Promise<InternalResponse<T | T[]>> {
